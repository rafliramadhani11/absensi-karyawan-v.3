...
<html lang="id">
    ...
    <head>
        <meta charset="UTF-8">
        <title>Kinerja Absensi Seluruh Karyawan</title>
        ...
        <div class="mx-auto w-full max-w-4xl p-8">
            ...
            <div class="mb-6">
                <h3 class="mb-2 text-left text-xl font-bold tracking-wider">
                    ABSENSI SEMUA KARYAWAN - {{ Carbon\Carbon::parse($start)->translatedFormat('j F Y') }} -
                ...
                <tbody>
                    @foreach ($attendances as $attendance)
                        ...
                        <tr>
                            ...
                            <td class="border border-gray-400 px-4 py-2">{{ $attendance->user->division->name }}</td>
                            <td class="border border-gray-400 px-4 py-2">{{ $attendance->user->name }}</td>
